...
export default function Page() {
  ...
  const steps = [
    {
      id: 0,
      title: 'Autenticação',
      description: 'Escaneie o QR code do WhatsApp',
    },
    {
      id: 1,
      title: 'Contatos',
      description: 'Selecione os contatos para envio',
    },
  ...
  return (
    <>
      <Head>
        <title>
          {process.env.NEXT_SITE_TITLE || 'Envio Automático de Mensagens'}
        </title>
      </Head>
      <main className="container mx-auto py-10 px-4">
        <Card className="max-w-4xl mx-auto relative">
          ...
          <CardContent>
            ...
            <div className="mt-8">
              {currentStep === 0 && (
                <QrCodeScanner onAuthenticated={handleQrCodeScanned} />
              )}
              ...
              {currentStep === 2 && <MessageComposer contacts={contacts} />}
            </div>
          </CardContent>
